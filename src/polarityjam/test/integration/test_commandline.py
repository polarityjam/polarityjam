...
class TestIntegration(TestCommon):
    ...
    def test_run(self):
        ...
        self.assertEqual(74, df.shape[1])
    ...
    def test_run_stack_no_golgi(self):
        ...
        # number of features should not change
        self.assertEqual(69, df1.shape[1])
        self.assertEqual(69, df2.shape[1])
        self.assertEqual(69, df3.shape[1])
    ...
    def test_run_stack_no_nuclei(self):
        ...
        # number of features should not change
        self.assertEqual(49, df1.shape[1])
        self.assertEqual(49, df2.shape[1])
        self.assertEqual(49, df3.shape[1])
